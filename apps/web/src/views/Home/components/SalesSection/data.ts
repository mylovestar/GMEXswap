...
export const swapSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  secondaryButton: {
    to: 'https://docs.kronoswap.finance',
    text: t('Learn'),
    external: true,
  },
  images: {
...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('GMEXSwap makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
  ...
  secondaryButton: {
    to: 'https://docs.kronoswap.finance/tutorials/yield-farming',
    text: t('Learn'),
    external: true,
  },
  images: {
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t(
    'XKR token is at the heart of the KronoSwap ecosystem. Buy it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
  ...
  secondaryButton: {
    to: 'https://docs.kronoswap.finance/governance/nebula-tokenomics',
    text: t('Learn'),
    external: true,
  },
